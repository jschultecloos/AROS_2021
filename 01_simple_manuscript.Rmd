...
You can manage your LaTeX packages by using `tinytex::tlmgr_install()` and `tinytex::tlmgr_remove()`. R Markdown will automatically install some LaTeX packages that are necessary for compilation, for instance, the `hyperref` package.
